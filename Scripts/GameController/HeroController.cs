...
public class HeroController : MonoBehaviour
{
    ...
    public MeleeUnit meleeUnitScrip;
    public RangedUnit rangedUnitScrip;
    ...
    {
        this.hero.transform.position += new Vector3(this.heroAttribute.speed * direction, 0) * this.heroAttribute.speed * Time.deltaTime;
    }
